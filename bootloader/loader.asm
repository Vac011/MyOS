...
Supported:
    ...
    ; 0x90000 PML4
    mov dword [0x90000], 0x91007  ; 低地址映射
    mov dword [0x90800], 0x91007  ; 高地址映射

    ; 0x91000 PDPT
    mov dword [0x91000], 0x92007  ; 指向 0x92000 的页表

    ; 0x92000 PD
    mov dword [0x92000], 0x000083  ; 2MB 页: 0x000000 (映射物理地址 0x000000)
    mov dword [0x92008], 0x200083  ; 2MB 页: 0x002000 (映射物理地址 0x200000)
    mov dword [0x92010], 0x400083  ; 2MB 页: 0x004000
    mov dword [0x92018], 0x600083  ; 2MB 页: 0x006000
    mov dword [0x92020], 0x800083  ; 2MB 页: 0x008000
    mov dword [0x92028], 0xa00083  ; 2MB 页: 0x00A000
